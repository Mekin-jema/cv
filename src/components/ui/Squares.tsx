...
const Squares: React.FC<SquaresProps> = ({
  ...
  // Set movement direction based on the direction prop
    const getDirection = () => {
      switch (direction) {
  ...
  // Add extra squares to ensure the whole viewport is covered
  ...
  // Boundary check - adjust to ensure seamless looping
  ...
  // Draw square - ensure it fully covers its area
